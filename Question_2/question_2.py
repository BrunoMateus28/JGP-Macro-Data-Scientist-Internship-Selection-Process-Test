...
Original file is located at
    https://colab.research.google.com/drive/1kPyChEBnggI3AWsRFHj2IQ1RAX9WkRwn
"""
...
df['series 2'] = pd.to_numeric(df['series 2'], errors='coerce')

df.sort_values('date', inplace=True)

df['pct_change'] = df['series 2'].pct_change(periods=12) * 100

fig = px.line(df, x='date', y='pct_change', title='Year-over-Year Percentage Variation of CPI (All Items, Less Food and Energy)',
              labels={'pct_change': 'Year-over-Year Percentage Change (%)'},
              line_shape='linear')
...
fig.update_layout(
    ...
    yaxis=dict(title='Year-over-Year Percentage Change (%)')
)
